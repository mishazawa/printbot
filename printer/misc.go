...
// var nodither colorquant.Quantizer = colorquant.NoDither

var concretePalette []color.Color = []color.Color{
...
var concreteColorMap map[color.Color]string = map[color.Color]string{
	color.RGBA{0xE9, 0xEC, 0xEC, 0xFF}: "white_concrete",
	color.RGBA{0xF0, 0x76, 0x13, 0xFF}: "orange_concrete",
	color.RGBA{0xBD, 0x44, 0xB3, 0xFF}: "magenta_concrete",
	color.RGBA{0x3A, 0xAF, 0xD9, 0xFF}: "light_blue_concrete",
	color.RGBA{0xF8, 0xC6, 0x27, 0xFF}: "yellow_concrete",
	color.RGBA{0x70, 0xB9, 0x19, 0xFF}: "lime_concrete",
	color.RGBA{0xED, 0x8D, 0xAC, 0xFF}: "pink_concrete",
	color.RGBA{0x3E, 0x44, 0x47, 0xFF}: "gray_concrete",
	color.RGBA{0x8E, 0x8E, 0x86, 0xFF}: "light_gray_concrete",
	color.RGBA{0x15, 0x89, 0x91, 0xFF}: "cyan_concrete",
	color.RGBA{0x79, 0x2A, 0xAC, 0xFF}: "purple_concrete",
	color.RGBA{0x35, 0x39, 0x9D, 0xFF}: "blue_concrete",
	color.RGBA{0x72, 0x47, 0x28, 0xFF}: "brown_concrete",
	color.RGBA{0x54, 0x6D, 0x1B, 0xFF}: "green_concrete",
	color.RGBA{0xA1, 0x27, 0x22, 0xFF}: "red_concrete",
	color.RGBA{0x14, 0x15, 0x19, 0xFF}: "black_concrete",
